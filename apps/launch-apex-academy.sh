...
# Launch script for Apex Academy
...
eval "$TERMINAL_CMD 'cd $PROJECT_ROOT/apps/nuxt && echo \"🎨 Apex Academy Frontend\" && $PACKAGE_MANAGER dev'"
...
echo "  ⚙️  API:       ${BLUE}http://localhost:4001${NC}"
echo "  📦 Convex:    ${BLUE}http://localhost:3210${NC}"
echo ""
echo "Press Enter to open the frontend in your browser..."
read -r
$OPEN_CMD http://localhost:3000 2>/dev/null || echo "Please open http://localhost:3000 manually"
