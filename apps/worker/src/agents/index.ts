...
export class AgentRegistry {
  ...
  constructor() {
    // Register all agents
    this.register(new AuthAgent());
    this.register(new CourseAgent());
    this.register(new TutoringAgent());
    this.register(new QuizAgent());
    this.register(new CodeAgent());
    this.register(new ProgressAgent());
    this.register(new ImageAgent());
    this.register(new StudyPlanAgent());
