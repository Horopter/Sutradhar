...
Apex Academy now supports a comprehensive, pluggable theme system with:
...
Theme preferences are automatically saved to `localStorage` with the key `apex-academy-theme`. The theme is restored on page load.
